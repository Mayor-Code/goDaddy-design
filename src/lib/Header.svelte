<div class="header flex justify-between items-center h-24 mx-[5vw]">
    <div class="flex basis-1/2 md:basis-full overflow-hidden">
        <div class="md:hidden flex items-center text-black text-4xl"><i class='bx bx-menu' ></i></div>
        <div class="logo-div mx-3 flex flex-col items-end">
            ...
            <p class="hidden md:block text-xsm text-left text-gray-600">United Kingdom</p>
        </div>
        <div class="hidden md:block lg:hidden flex items-center text-black text-4xl"><i class='bx bx-menu' ></i></div>
        <ul class="hidden lg:flex items-center text-neutral-500">
            <li class="mx-3 hover:text-black">Domain Names</li>
            <li class="mx-3 hover:text-black">Websites & Hosting</li>
            <li class="mx-3 hover:text-black">Email & Marketing</li>
        </ul>
    </div>
    <div class="flex items-center md:basis-0">
        <div class="flex mx-3 items-center">
            <span class="hidden xl:block">07012345678</span>
            <span class="text-2xl hidden xl:block"><i class='bx bx-chevron-down'></i></span>
            <span class="xl:hidden text-2xl"><i class='bx bx-phone'></i></span>
        </div>
        <div class="flex items-center mx-3">
            <span class="hidden xl:block">Help</span>
            <span class="xl:hidden text-2xl"><i class='bx bx-question-mark'></i></span>
        </div>
        <div class="flex mx-3 items-center">
            <span class="hidden xl:block">Sign in</span>
            <span class="text-2xl hidden xl:block"><i class='bx bx-chevron-down'></i></span>
            <span class="xl:hidden text-2xl"><i class='bx bx-user'></i></span>
        </div>
        <div class="flex mx-3 items-center">
